...
--
-- Host: localhost:3306
-- Generation Time: Feb 13, 2023 at 04:06 AM
...
--
CREATE DATABASE IF NOT EXISTS `randigro_apotekupdate` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `randigro_apotekupdate`;
